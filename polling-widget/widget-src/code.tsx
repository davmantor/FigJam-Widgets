    ...
    figma.ui.onmessage = async (msg) => {
      if (msg.type === 'update-prompt') {
        ...
        figma.ui.onmessage = msg => {
          ...
          console.log("calling prompt from options - heading font size", msg);
          const updatedText = msg.payload;
          setHeadingFontSize(parseInt(updatedText, 10));
          alreadyLoggedIn = true;
      } else if (msg.type === 'update-subheadingFontSize') {
          console.log("calling prompt from options - subheading font size", msg);
          const updatedText = msg.payload;
          setSubheadingFontSize(parseInt(updatedText, 10));
          alreadyLoggedIn = true;
      } else if (msg.type === 'update-choiceFontSize') {
          console.log("calling prompt from options - choice font size", msg);
          const updatedText = msg.payload;
