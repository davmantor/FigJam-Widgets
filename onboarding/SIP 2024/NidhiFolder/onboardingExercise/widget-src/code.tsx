...
const rectangle = [10, 20, 30, 40, 50, 60]
const colors = ['FF000', '00FF00', '00FFFF', 'FFA500', 'FFFFF', '00FFF']
const Input = ["input 1", "input ", "input 3", "input 4", "input 5", "input 6"]
...
function BarGraphWidget() {
  const [count, setCount] = useSyncedState('count', 10)
  ...
  <rect width="30" height="30" rx="15" fill="pink"/>
  ...
  <rect x="100" y="150" width="29" height="29" rx="14.5" stroke="black" stroke-opacity="0.1"/>
</svg>`}
  x = {200} y= {600}
  onClick={() => {
    setCount(count + 10)
...
{<SVG
        src={`<svg width="1000" height="170" xmlns="http://www.w3.org/2000/svg">

  <rect width="80" height="20" x="20" y="80"
  style="fill:red;stroke:red;stroke-width:0;fill-opacity:0.1;stroke-opacity:0.9" />

  <rect width="80" height="30" x="120" y="70"
  style="fill:orange;stroke:orange;stroke-width:0;fill-opacity:0.1;stroke-opacity:0.9" />

  <rect width="80" height="40" x="220" y="60"
  style="fill:yellow;stroke:yellow;stroke-width:0;fill-opacity:0.1;stroke-opacity:0.9" />

  <rect width="80" height="50" x="320" y="50"
  style="fill:green;stroke:green;stroke-width:0;fill-opacity:0.1;stroke-opacity:0.9" />

  <rect width="80" height="60" x="420" y="40"
  style="fill:blue;stroke:blue;stroke-width:0;fill-opacity:0.1;stroke-opacity:0.9" />

  <rect width="80" height="70" x="520" y="30"
  style="fill:black;stroke:black;stroke-width:0;fill-opacity:0.1;stroke-opacity:0.9" />
